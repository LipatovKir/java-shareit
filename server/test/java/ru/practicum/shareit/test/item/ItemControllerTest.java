...
class ItemControllerTest {
    ...
    @Test
    void updateItem() {
        when(itemService.updateItem(any(ItemDto.class), anyLong(), anyLong(),anyInt(),anyInt())).thenReturn(firstitemDto);
    ...
    void getAllItemsUser() {
        when(itemService.getAllItemsByOwnerId(anyLong(), anyInt(), anyInt())).thenReturn(List.of(firstitemDto, secondItemDto));
        ...
        verify(itemService, times(1)).getAllItemsByOwnerId(1L, 0, 10);
    }
